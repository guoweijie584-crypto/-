...
**Current focus:** Phase 1: App Skeleton And Demo Migration
...
|-------|-------|-------|----------|
| 1. App Skeleton And Demo Migration | 0/3 | 0.0h | N/A |
...
- Current demo is desktop-keyboard/mouse oriented; mobile controls are a Phase 4 requirement.
